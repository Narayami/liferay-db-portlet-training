...
import com.liferay.training.movies.model.AuthorModel;
import com.liferay.training.movies.model.AuthorSoap;
...
/**
 * The base model implementation for the Author service. Represents a row in the &quot;movies_Author&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AuthorModelImpl extends BaseModelImpl<Author>
	 ...
	 */
	public static final String TABLE_NAME = "movies_Author";
	...
	public static final String TABLE_SQL_CREATE = "create table movies_Author (uuid_ VARCHAR(75) null,authorId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,authorName VARCHAR(75) null,biography VARCHAR(75) null,movieId LONG)";
	public static final String TABLE_SQL_DROP = "drop table movies_Author";
	public static final String ORDER_BY_JPQL = " ORDER BY author.authorId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY movies_Author.authorId ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.training.movies.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.training.movies.model.Author"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.training.movies.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.training.movies.model.Author"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.training.movies.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.training.movies.model.Author"),
			true);
	public static final long AUTHORID_COLUMN_BITMASK = 1L;
	public static final long AUTHORNAME_COLUMN_BITMASK = 2L;
	public static final long COMPANYID_COLUMN_BITMASK = 4L;
	public static final long GROUPID_COLUMN_BITMASK = 8L;
	public static final long MOVIEID_COLUMN_BITMASK = 16L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.training.movies.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.training.movies.model.Author"));
	...
	public Object clone() {
		...
		authorImpl.setBiography(getBiography());
		authorImpl.setMovieId(getMovieId());
	...
	public void resetOriginalValues() {
		...
		authorModelImpl._originalAuthorId = authorModelImpl._authorId;

		authorModelImpl._setOriginalAuthorId = false;
		...
		authorModelImpl._originalAuthorName = authorModelImpl._authorName;

		authorModelImpl._originalMovieId = authorModelImpl._movieId;

		authorModelImpl._setOriginalMovieId = false;
	...
	public CacheModel<Author> toCacheModel() {
		...
		authorCacheModel.biography = getBiography();

		String biography = authorCacheModel.biography;

		if ((biography != null) && (biography.length() == 0)) {
			authorCacheModel.biography = null;
		}

		authorCacheModel.movieId = getMovieId();
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.training.movies.model.Author");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>biography</column-name><column-value><![CDATA[");
		sb.append(getBiography());
		sb.append("]]></column-value></column>");
		sb.append(
