...
public class AuthorServiceWrapper implements AuthorService,
	...
	public com.liferay.training.movies.model.Author addAuthor(long movieId,
		...
		return _authorService.addAuthor(movieId, authorName, biography,
			serviceContext);
	}
	...
	public java.util.List<com.liferay.training.movies.model.Author> getAuthorsByGroupId(
		...
		return _authorService.getAuthorsByGroupId(groupId, start, end);
	}
	...
	*/
	...
	public com.liferay.training.movies.model.Author updateAuthor(
		...
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _authorService.updateAuthor(authorId, authorName, biography,
			serviceContext);
	}
